...
export const graduationCheckCommand: QtcCommand = {
  ...
  describe:
    "Hub mode: detecta artefactos graduados a fuentes (docs/manuales|propuestas|post-mortems|analisis|refactors) sin breadcrumb en <hub>/docs/<categoria>/000-INDEX.md. Skip silencioso en project mode.",
