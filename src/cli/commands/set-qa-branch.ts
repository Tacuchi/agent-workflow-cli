...
export const setQaBranchCommand: QtcCommand = {
  name: "set-qa-branch",
  describe:
    "Set the QA branch for a source in the WORKSPACE block. Usage: aw set-qa-branch <alias> <rama>.",
  async execute(args: ParsedArgs, ctx: CliContext): Promise<CommandResult> {
    ...
    if (!alias || !rama) {
      return {
        ...
        error: {
          code: "INVALID_INPUT",
          message: "Usage: aw set-qa-branch <alias> <rama>",
        },
        exitCode: 1,
      };
    }
